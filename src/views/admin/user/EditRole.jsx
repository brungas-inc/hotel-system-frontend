...
const EditRole = (props) => {
  ...
  const [checked, setChecked] = useState([
    ...props.item.permissions.map((item) => item._id),
  ]);
  const {
    data: permissions,
    loading,
  ...
  const submit = (setSubmitting, values) => {
    ...
    window.axios
      .patch(
        `${BASE_URL}access-control/roles/${props.item._id}`,
        {
          ...values,
          permissions: [...checked],
        },
            ...
            <CardBody>
              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-x-4 mt-5 ">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="overflow-y-auto h-64 scrollbar-thin scrollbar-thumb-primaryDark scrollbar-track-gray-300 flex flex-col">
